...
- (void)viewDidLoad
{
    ...
    [self.winLoseLabel setCenter:CGPointMake(CGRectGetMidX(frame), 100)];
    [self.winLoseLabel setTextAlignment:NSTextAlignmentCenter];
    [self.winLoseLabel setFont:[UIFont fontWithName:@"Futura-CondensedExtraBold" size:50.0f]];
    ...
    [self.levelLabel setCenter:CGPointMake(CGRectGetMidX(frame), 50)];
    ...
    [self.levelScoreLabel setCenter:CGPointMake(CGRectGetMidX(frame), 150)];
    ...
    [self.totalScoreLabel setCenter:CGPointMake(CGRectGetMidX(frame), 200)];
    ...
    [self.totalScoreLabel setText:[NSString stringWithFormat:@"Total Score: %i", self.gameBrain.totalScore + self.gameBrain.levelScore]];
